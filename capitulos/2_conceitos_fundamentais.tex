...
A Tabela~\ref{tab:eventosPAPI} apresenta algum dos eventos que podem ser mensurados com a ferramenta PAPI e estão disponíveis para o computador descrito na Seção~\ref{sec:infraestrutura_experimental}.
