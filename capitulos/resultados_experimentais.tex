...
\section{Problema A: Verificação dos Limites do Chip}
...
\section{Problema B: Estimativa de Interconexão}
...
Diferente do Problema~A, nesta tarefa é necessário acessar diferentes \textit{entity-component systems} (interconexões e pinos) e múltiplas propriedades. Complementarmente, os pinos pertencentes a cada interconexão podem não estar contíguos em memória, o que impacta na performance. 
...
\section{Problema C: Clusterização de Registradores}
