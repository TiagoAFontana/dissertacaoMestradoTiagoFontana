...
Esse desperdício de memória prejudica a exploração da localidade espacial pela memória cache e, consequentemente, degrada o tempo de execução do software.
...
Como consequência, este modelo de programação proporciona um aumento na localidade espacial dos dados possibilitando que mais dados na cache sejam utilizados, e assim, reduzindo o tempo total de execução.
...
Os resultados experimentais preliminares mostraram que a implementação do modelo orientado a dados (Data-Oriented Design) reduz o número total de \textit{cache misses} e é mais rápido do que a implementação com o paradigma Orientado a Objetos.
\todo{Colocar resultados no final do resumo}
}
\palavrasChave{ 
...
This memory wasting harms  exploitation of locality by the cache                               , consequently, degrades software runtime. 
This work proposes an efficient organization of the data for three different algorithms of Physical Design.
For this data organization, this work apply Data-Oriented Design.
