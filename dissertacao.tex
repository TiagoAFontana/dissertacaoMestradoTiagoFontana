...
\epigrafe{Alguns homens vêem as coisas como são, e dizem ‘Por quê?’ Eu sonho com as coisas que nunca foram e digo ‘Por que não?'}{George Bernard Shaw}
...
\input{capitulos/1_introducao}
    ...
    % metodologia;
    % contribuições;
\input{capitulos/2_conceitos_fundamentais.tex}

\input{capitulos/3_trabalhos_correlatos}
    % revisão bibliográfica;
\input{capitulos/4_tecnica_proposta}
    % proposta;

\input{capitulos/5_caracterizacao_sintese_fisica}


\input{capitulos/6_resultados_experimentais}

\input{capitulos/7_conclusao_e_trabalhos_futuros}
...
% \input{capitulos/trabalhos_correlatos}
% \input{capitulos/tecnica_proposta}
% \input{capitulos/resultados_experimentais}
% \input{capitulos/cronograma}
...
\apendice
\input{capitulos/lista_de_producoes}
